...
const AgentForm = () => {
  ...
  const handleServicesPlanChange = (data) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const updatedFormData = {
      ...formData,
      product_dict: productDict[0] || {}, // <--- Sync here
    };
  
    console.log("Final data being submitted:", updatedFormData);
...
//   //           'Content-Type': 'application/json',
//   //         },
//   //         body: JSON.stringify({ company_name: formData.company_name }), // agar company_name bhejna zaruri hai
//   //       });
  
//   //       const data = await response.json();
  
//   //       if (data?.List) {
//   //         const emails = data.List.map((item) => item.business_email);
...
//     setPrice(totalPrice);  // This will update the price in AgentForm
//   };
...
//           <ServicesPlan
//   onChange={({ productDict = [], totalPrice = 0 }) => {
//     setProductDict(productDict);  // store full productDict

//     const firstProduct = productDict[0] || {
//       company_name: '',
//       type: '',
//       subscription: '',
//       free_addons: [],
...
//     setFormData((prevData) => ({
//       ...prevData,
//       product_dict: firstProduct,
//       company_name: firstProduct.company_name,
//     }));
//   }}
// />
...
//             {/* <div>
//       <div className="mt-4">
//         <label className="block text-md font-medium text-gray-700">Total Price</label>
//         <input
//           type="number"
//           value={price}
//           readOnly
